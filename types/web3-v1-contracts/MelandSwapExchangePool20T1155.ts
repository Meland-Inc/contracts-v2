...
export interface MelandSwapExchangePool20T1155 extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): MelandSwapExchangePool20T1155;
  clone(): MelandSwapExchangePool20T1155;
  methods: {
    /**
    ...
    productId(): NonPayableTransactionObject<string>;
    ...
    totalSupplie(): NonPayableTransactionObject<string>;

    getERC20AvailableSpace(): NonPayableTransactionObject<string>;
  };
  events: {
